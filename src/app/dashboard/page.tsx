    ...
    if (option.action === "forgot") {
      return (
        <div
          ...
          className="flex flex-col items-center justify-center py-6 px-8 border  hover:border-[#004265] bg-white/40 transition-colors duration-200 text-lg font-medium group text-center cursor-pointer"
      ...
      <div className="min-h-screen px-4 sm:px-6 py-12 lg:px-8 font-sans!">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 border shadow-md p-6 sm:p-8">
